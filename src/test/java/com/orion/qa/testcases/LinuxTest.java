...
*/		
		...
		System.out.println("Add Attachment is displayed" + eventDriver.findElement(By.xpath("//a[contains(text(), 'Add Attachment')]")).isDisplayed());
		Thread.sleep(3000);
	...
	public static void Event_DownloadDocfromExternal() throws InterruptedException, ClientProtocolException, IOException {
