...
public class Test_PreApprovedTimeSheet_SubmitFunctionality extends OrionBase{
	...
	public void Test_IfEditTimeSheetPage_Isdisplayed() {
		...
		strMonth = CommonMethods.readTestData("TD_Preapproved_Submit", "PreApprovedTimeSheet");
		log.info("Get report period details from the test data input file. " + strMonth);

		rptPeriod = CommonMethods.readTestData("TD_Preapproved_Submit", "PreApprovedTimeSheetRptPeriod");
	...
	public void Test_IfUpdatedDataisSubmitted() {
		try {
			...
			*/
			...
			assertTrue(comment.equals(CommonMethods.readTestData("TD_Preapproved_Submit", "comment")));
	...
	public void InjectTestData() {
		try {
			...
			Element1.clear();
			Element1.sendKeys(CommonMethods.readTestData("TD_Preapproved_Submit", "comment"));
